...
- The approved desktop H1 is the original PC rendering from commit `24ab1a4`: `Impact` first, without `font-synthesis` or text stroke. On mobile, use Montserrat 900 for H1 and CTA, Montserrat 600 for H2, and the bundled Barlow Condensed 900 only for the amount.
